// -*- C++ -*-
//
// Package:    METPuppiDouble
// Class:      METPuppiDouble
// 
/**\class METPuppiDouble METPuppiDouble.cc RA2Classic/METPuppiDouble/src/METPuppiDouble.cc
 * 
...
class METPuppiDouble : public edm::EDProducer {
public:
	explicit METPuppiDouble(const edm::ParameterSet&);
	~METPuppiDouble();
...
//
METPuppiDouble::METPuppiDouble(const edm::ParameterSet& iConfig)
...
void
METPuppiDouble::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
	using namespace edm;
	...
	if (corrMet) {
	  ...
	  else std::cout<<"METPuppiDouble::Invlide Tag: "<<metTag_.label()<<std::endl;
	}
...
void 
METPuppiDouble::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
METPuppiDouble::endJob() {
}

// ------------ method called when starting to processes a run  ------------
void 
METPuppiDouble::beginRun(edm::Run&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a run  ------------
void 
METPuppiDouble::endRun(edm::Run&, edm::EventSetup const&)
{
}

// ------------ method called when starting to processes a luminosity block  ------------
void 
METPuppiDouble::beginLuminosityBlock(edm::LuminosityBlock&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a luminosity block  ------------
void 
METPuppiDouble::endLuminosityBlock(edm::LuminosityBlock&, edm::EventSetup const&)
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
METPuppiDouble::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(METPuppiDouble);
