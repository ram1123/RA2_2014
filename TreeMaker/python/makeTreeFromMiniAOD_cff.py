...
#    JetTag  = cms.InputTag('HTJets'),
    ...
    uncFile = cms.string("Summer15_25nsV7_DATA_Uncertainty_AK4PFchs.txt"),
...
#    puppiJetTag = cms.InputTag('selectedPuppiJetsAK8'),
    ...
    uncFile = cms.string("Summer15_25nsV7_DATA_Uncertainty_AK8PFchs.txt"),
...
#    if doPuppi:
    process.JetsPropertiesPuppiAK8 = jetpropertiesPuppiAK8.clone(
        ...
        L1File = cms.string("Summer15_25nsV7_DATA_L1FastJet_AK8PFPuppi.txt"),
        L2File = cms.string("Summer15_25nsV7_DATA_L2Relative_AK8PFPuppi.txt"),
        L3File = cms.string("Summer15_25nsV7_DATA_L3Absolute_AK8PFPuppi.txt"),
        L2L3File = cms.string("Summer15_25nsV7_DATA_L2L3Residual_AK8PFPuppi.txt"),
        uncFile = cms.string("Summer15_25nsV7_DATA_Uncertainty_AK8PFPuppi.txt"),
        #    jecPayloadNames      = cms.vstring(jecLevelsAK8),
        #    BTagInputTag	        = cms.string('combinedInclusiveSecondaryVertexV2BJetTags'),
        )
    ...
    MinPt = cms.double(-1),
    doJEC  = cms.bool(doJECCorrection),
    L1File = cms.string("Summer15_25nsV7_DATA_L1FastJet_AK4PFPuppi.txt"),
    L2File = cms.string("Summer15_25nsV7_DATA_L2Relative_AK4PFPuppi.txt"),
    L3File = cms.string("Summer15_25nsV7_DATA_L3Absolute_AK4PFPuppi.txt"),
    L2L3File = cms.string("Summer15_25nsV7_DATA_L2L3Residual_AK4PFPuppi.txt"),
    uncFile = cms.string("Summer15_25nsV7_DATA_Uncertainty_AK4PFPuppi.txt"),
#    jecPayloadNames      = cms.vstring(jecLevelsAK4),
#    BTagInputTag	        = cms.string('combinedInclusiveSecondaryVertexV2BJetTags'),
    )
    ...
    if (MC):
        process.JetsProperties.L1File = cms.string("Spring16_25nsV1_MC_L1FastJet_AK4PFchs.txt")
        process.JetsProperties.L2File = cms.string("Spring16_25nsV1_MC_L2Relative_AK4PFchs.txt")
        process.JetsProperties.L3File = cms.string("Spring16_25nsV1_MC_L3Absolute_AK4PFchs.txt")
        process.JetsProperties.L2L3File = cms.string("NONE")
        process.JetsProperties.uncFile = cms.string("Spring16_25nsV1_MC_Uncertainty_AK4PFchs.txt")
        process.JetsPropertiesAK8.L1File = cms.string("Spring16_25nsV1_MC_L1FastJet_AK8PFchs.txt")
        process.JetsPropertiesAK8.L2File = cms.string("Spring16_25nsV1_MC_L2Relative_AK8PFchs.txt")
        process.JetsPropertiesAK8.L3File = cms.string("Spring16_25nsV1_MC_L3Absolute_AK8PFchs.txt")
        process.JetsPropertiesAK8.L2L3File = cms.string("NONE")
        process.JetsPropertiesAK8.uncFile = cms.string("Spring16_25nsV1_MC_Uncertainty_AK8PFchs.txt")
        process.JetsPropertiesAK10.L1File = cms.string("Spring16_25nsV1_MC_L1FastJet_AK8PFchs.txt")
        process.JetsPropertiesAK10.L2File = cms.string("Spring16_25nsV1_MC_L2Relative_AK8PFchs.txt")
        process.JetsPropertiesAK10.L3File = cms.string("Spring16_25nsV1_MC_L3Absolute_AK8PFchs.txt")
        process.JetsPropertiesAK10.L2L3File = cms.string("NONE")
        process.JetsPropertiesAK10.uncFile = cms.string("Spring16_25nsV1_MC_Uncertainty_AK8PFchs.txt")
        process.JetsPropertiesAK12.L1File = cms.string("Spring16_25nsV1_MC_L1FastJet_AK8PFchs.txt")
        process.JetsPropertiesAK12.L2File = cms.string("Spring16_25nsV1_MC_L2Relative_AK8PFchs.txt")
        process.JetsPropertiesAK12.L3File = cms.string("Spring16_25nsV1_MC_L3Absolute_AK8PFchs.txt")
        process.JetsPropertiesAK12.L2L3File = cms.string("NONE")
        process.JetsPropertiesAK12.uncFile = cms.string("Spring16_25nsV1_MC_Uncertainty_AK8PFchs.txt")
        process.JetsPropertiesPuppiAK8.L1File = cms.string("Spring16_25nsV1_MC_L1FastJet_AK8PFPuppi.txt")
        process.JetsPropertiesPuppiAK8.L2File = cms.string("Spring16_25nsV1_MC_L2Relative_AK8PFPuppi.txt")
        process.JetsPropertiesPuppiAK8.L3File = cms.string("Spring16_25nsV1_MC_L3Absolute_AK8PFPuppi.txt")
        process.JetsPropertiesPuppiAK8.L2L3File = cms.string("NONE")
        process.JetsPropertiesPuppiAK8.uncFile = cms.string("Spring16_25nsV1_MC_Uncertainty_AK8PFPuppi.txt")
        process.JetsPropertiesPuppi.L1File = cms.string("Spring16_25nsV1_MC_L1FastJet_AK4PFPuppi.txt")
        process.JetsPropertiesPuppi.L2File = cms.string("Spring16_25nsV1_MC_L2Relative_AK4PFPuppi.txt")
        process.JetsPropertiesPuppi.L3File = cms.string("Spring16_25nsV1_MC_L3Absolute_AK4PFPuppi.txt")
        process.JetsPropertiesPuppi.L2L3File = cms.string("NONE")
        process.JetsPropertiesPuppi.uncFile = cms.string("Spring16_25nsV1_MC_Uncertainty_AK4PFPuppi.txt")
...
#    corrMet = cms.bool(True),
    ...
    if (MC):
        process.MET.L1File = cms.string("Spring16_25nsV1_MC_L1FastJet_AK4PFchs.txt")
        process.MET.L2File = cms.string("Spring16_25nsV1_MC_L2Relative_AK4PFchs.txt")
        process.MET.L3File = cms.string("Spring16_25nsV1_MC_L3Absolute_AK4PFchs.txt")
        process.MET.L2L3File = cms.string("NONE")
        process.MET.uncFile = cms.string("Spring16_25nsV1_MC_Uncertainty_AK4PFchs.txt")
        process.METpuppi.L1File = cms.string("Spring16_25nsV1_MC_L1FastJet_AK4PFPuppi.txt")
        process.METpuppi.L2File = cms.string("Spring16_25nsV1_MC_L2Relative_AK4PFPuppi.txt")
        process.METpuppi.L3File = cms.string("Spring16_25nsV1_MC_L3Absolute_AK4PFPuppi.txt")
        process.METpuppi.L2L3File = cms.string("NONE")
        process.METpuppi.uncFile = cms.string("Spring16_25nsV1_MC_Uncertainty_AK4PFPuppi.txt")
