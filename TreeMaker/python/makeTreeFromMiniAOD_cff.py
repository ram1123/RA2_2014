...
#    BTagInputTag	        = cms.string('combinedInclusiveSecondaryVertexV2BJetTags'),
    ...
    if (MC):
        ...
        process.JetsProperties.uncFile = cms.string("Summer15_25nsV7_MC_Uncertainty_AK4PFchs.txt")
        ...
        process.JetsPropertiesAK8.uncFile = cms.string("Summer15_25nsV7_MC_Uncertainty_AK8PFchs.txt")
        process.JetsPropertiesAK10.L1File = cms.string("Summer15_25nsV7_MC_L1FastJet_AK8PFchs.txt")
        process.JetsPropertiesAK10.L2File = cms.string("Summer15_25nsV7_MC_L2Relative_AK8PFchs.txt")
        process.JetsPropertiesAK10.L3File = cms.string("Summer15_25nsV7_MC_L3Absolute_AK8PFchs.txt")
        process.JetsPropertiesAK10.L2L3File = cms.string("NONE")
        process.JetsPropertiesAK10.uncFile = cms.string("Summer15_25nsV7_MC_Uncertainty_AK8PFchs.txt")
        process.JetsPropertiesAK12.L1File = cms.string("Summer15_25nsV7_MC_L1FastJet_AK8PFchs.txt")
        process.JetsPropertiesAK12.L2File = cms.string("Summer15_25nsV7_MC_L2Relative_AK8PFchs.txt")
        process.JetsPropertiesAK12.L3File = cms.string("Summer15_25nsV7_MC_L3Absolute_AK8PFchs.txt")
        process.JetsPropertiesAK12.L2L3File = cms.string("NONE")
        process.JetsPropertiesAK12.uncFile = cms.string("Summer15_25nsV7_MC_Uncertainty_AK8PFchs.txt")
        process.JetsPropertiesPuppiAK8.L1File = cms.string("Summer15_25nsV7_MC_L1FastJet_AK8PFPuppi.txt")
        process.JetsPropertiesPuppiAK8.L2File = cms.string("Summer15_25nsV7_MC_L2Relative_AK8PFPuppi.txt")
        process.JetsPropertiesPuppiAK8.L3File = cms.string("Summer15_25nsV7_MC_L3Absolute_AK8PFPuppi.txt")
        process.JetsPropertiesPuppiAK8.L2L3File = cms.string("NONE")
        process.JetsPropertiesPuppiAK8.uncFile = cms.string("Summer15_25nsV7_MC_Uncertainty_AK8PFPuppi.txt")
        process.JetsPropertiesPuppi.L1File = cms.string("Summer15_25nsV7_MC_L1FastJet_AK4PFPuppi.txt")
        process.JetsPropertiesPuppi.L2File = cms.string("Summer15_25nsV7_MC_L2Relative_AK4PFPuppi.txt")
        process.JetsPropertiesPuppi.L3File = cms.string("Summer15_25nsV7_MC_L3Absolute_AK4PFPuppi.txt")
        process.JetsPropertiesPuppi.L2L3File = cms.string("NONE")
        process.JetsPropertiesPuppi.uncFile = cms.string("Summer15_25nsV7_MC_Uncertainty_AK4PFPuppi.txt")
...
#    corrMet = cms.bool(True),
    ...
    if (MC):
        ...
        process.MET.uncFile = cms.string("Summer15_25nsV7_MC_Uncertainty_AK4PFchs.txt")
        process.METpuppi.L1File = cms.string("Summer15_25nsV7_MC_L1FastJet_AK4PFPuppi.txt")
        process.METpuppi.L2File = cms.string("Summer15_25nsV7_MC_L2Relative_AK4PFPuppi.txt")
        process.METpuppi.L3File = cms.string("Summer15_25nsV7_MC_L3Absolute_AK4PFPuppi.txt")
        process.METpuppi.L2L3File = cms.string("NONE")
        process.METpuppi.uncFile = cms.string("Summer15_25nsV7_MC_Uncertainty_AK4PFPuppi.txt")
