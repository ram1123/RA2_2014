...
config.General.requestName = 'data_Jet_Run2015A-PromptReco-v1'
config.General.workArea = 'data_Jet_Run2015A-PromptReco-v1'
...
config.Data.inputDataset = '/Jet/Run2015A-PromptReco-v1/AOD'
config.Data.unitsPerJob = 50
config.Data.publication = True
config.Data.inputDBS = 'global' #'http://cmsdbsprod.cern.ch/cms_dbs_prod_global/servlet/DBSServlet'
config.Data.splitting = 'LumiBased'
config.Data.outLFNDirBase = '/store/group/dpg_ecal/alca_ecalcalib/ecalMIBI/lbrianza/miniAOD/data_Jet_Run2015A-PromptReco-v1/'
