...
if __name__ == '__main__':
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/WWScattering/aQGC_16July2016/TTbar_madgraph/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/WWScattering/aQGC_16July2016/TTbar_powheg/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/user/rasharma/WWScattering/aQGC_16July2016/sch/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
