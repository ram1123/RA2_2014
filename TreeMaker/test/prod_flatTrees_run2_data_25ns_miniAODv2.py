...
if __name__ == '__main__':
    ...
    config.General.workArea = 'newMINIAOD_11nov_v1_Cert_246908-258750_13TeV_PromptReco_Collisions15_25ns_JSON'
    ...
    config.Data.outLFNDirBase = '/store/group/dpg_ecal/alca_ecalcalib/ecalMIBI/lbrianza/newMINIAOD_11nov_v1_Cert_246908-258750_13TeV_PromptReco_Collisions15_25ns_JSON/data_mu_prompt_25ns_runC/'
    ...
    config.Data.outLFNDirBase = '/store/group/dpg_ecal/alca_ecalcalib/ecalMIBI/lbrianza/newMINIAOD_11nov_v1_Cert_246908-258750_13TeV_PromptReco_Collisions15_25ns_JSON/data_el_prompt_25ns_runC/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/group/dpg_ecal/alca_ecalcalib/ecalMIBI/lbrianza/newMINIAOD_11nov_v1_Cert_246908-258750_13TeV_PromptReco_Collisions15_25ns_JSON/data_mu_05Oct_25ns_runD/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/group/dpg_ecal/alca_ecalcalib/ecalMIBI/lbrianza/newMINIAOD_11nov_v1_Cert_246908-258750_13TeV_PromptReco_Collisions15_25ns_JSON/data_el_05Oct_25ns_runD/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/group/dpg_ecal/alca_ecalcalib/ecalMIBI/lbrianza/newMINIAOD_11nov_v1_Cert_246908-258750_13TeV_PromptReco_Collisions15_25ns_JSON/data_mu_prompt_v4_25ns_runD/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
    ...
    config.Data.outLFNDirBase = '/store/group/dpg_ecal/alca_ecalcalib/ecalMIBI/lbrianza/newMINIAOD_11nov_v1_Cert_246908-258750_13TeV_PromptReco_Collisions15_25ns_JSON/data_el_prompt_v4_25ns_runD/'
    from multiprocessing import Process
    p = Process(target=submit, args=(config,))
    p.start()
    p.join()
