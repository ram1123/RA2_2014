...
config.Data.inputDataset = '/Jet/lbrianza-crab_data_Jet_Run2015A-PromptReco-v1-e050d919924aa3d4cdb5e91105bf430f/USER'
config.Data.unitsPerJob = 50
config.Data.inputDBS = 'phys03' #'http://cmsdbsprod.cern.ch/cms_dbs_prod_global/servlet/DBSServlet'
config.Data.splitting = 'LumiBased'
config.Data.outLFNDirBase = '/store/group/dpg_ecal/alca_ecalcalib/ecalMIBI/lbrianza/ntuple_data/'
